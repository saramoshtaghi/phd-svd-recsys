#!/usr/bin/env python3
# SVD_0126.py
# Run Surprise SVD over SINGLE-GENRE injection files (pos=5) for N in {1215, 2000}
# AND also run the same setup for the ORIGINAL dataset (baseline) and save results.
...
OUT_DIR = Path(
    "/home/moshtasa/Research/phd-svd-recsys/Book/0126_similar_pr/SVD-0126/result/SVD_Single_Injection/5"
)
