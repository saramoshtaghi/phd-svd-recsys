...
# ========= CONFIG =========
BASE_DIR    = Path("/home/moshtasa/Research/phd-svd-recsys/Book")
INPUT_CSV   = BASE_DIR / "SVD/data/df_final_with_genres.csv"   # must have user_id, book_id, rating, genres
OUT_DIR = BASE_DIR / "0126_similar_pr/Data(general)"
SUMMARY_TXT = OUT_DIR / "summary_injection.txt"
SUMMARY_CSV = OUT_DIR / "summary_injection.csv"
...
RUNS = [2 ,4 ,6 ,25 ,50 ,100 ,200 ,300 ,350 , 500 ,1000, 1215, 2000]
