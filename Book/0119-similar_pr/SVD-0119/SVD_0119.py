...
# ========= PATHS =========
ORIGINAL_PATH = Path("/home/moshtasa/Research/phd-svd-recsys/Book/SVD/data/df_final_with_genres.csv")

# Input folder with f_<GENRE>_<N>u_pos5_neg*_*.csv
SINGLE_INJ_ROOT = Path("/home/moshtasa/Research/phd-svd-recsys/Book/0119-similar_pr/Data")

# Output folder
RESULTS_ROOT = Path("/home/moshtasa/Research/phd-svd-recsys/Book/0119-similar_pr/SVD-0119/result/SVD_Single_Injection")
