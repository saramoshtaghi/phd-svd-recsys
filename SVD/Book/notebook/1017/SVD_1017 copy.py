...
# ========= SETTINGS =========
TOP_N_LIST = [15, 25, 35]
N_FILTER = {2, 4, 6, 25, 50, 100, 200, 300, 350, 500,1000}   # only run these n-user variants
...
def scan_single_genre_pos5(root: Path):
    """
    Return POS=5 single-genre files under Single_Injection/, filtered to N in {2,4,6, 25, 50, 100, 200, 300, 350}.
...
def main():
    start = time.time()
    now("=== SVD (poison-only) — SINGLE GENRE (POS=5 ONLY, N ∈ {2,4,6, 25, 50, 100, 200, 300, 350}) ===")
