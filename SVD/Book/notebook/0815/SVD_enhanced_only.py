...
RESULTS_DIR          = "/home/moshtasa/Research/phd-svd-recsys/SVD/Book/result/rec/top_re/0915/enhanced_analysis"
...
def main():
    ...
    log_with_timestamp("=== SVD DATA POISONING ATTACK (ENHANCED/IMPROVED SYNTHETIC DATASETS ONLY) ===")
    ...
    # Process IMPROVED/ENHANCED synthetic datasets only
    log_with_timestamp("Processing ENHANCED/IMPROVED synthetic datasets...")
    total_processed = process_synthetic_directory(
        directory_path=IMPROVED_SYNTHETIC_DIR,
        directory_name="enhanced",
        original_users=original_users,
        genre_mapping=genre_mapping,
    )
    ...
    log_with_timestamp("=" * 80)
    log_with_timestamp(f"ENHANCED SYNTHETIC EXPERIMENT COMPLETED!")
    log_with_timestamp(f"Processed: {total_processed} enhanced synthetic datasets + 1 original dataset")
