...
def main():
    ...
    log_with_timestamp("=== SVD DATA POISONING ATTACK (PRIMARY GENRE SYNTHETIC DATASETS ONLY) ===")
    ...
    # Process PRIMARY GENRE synthetic datasets only
    ...
    log_with_timestamp(f"Processed: {total_processed} primary synthetic datasets + 1 original dataset")
