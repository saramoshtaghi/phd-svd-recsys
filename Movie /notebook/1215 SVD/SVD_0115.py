#!/usr/bin/env python3
# SVD_1215_movie_original_and_injected.py
# Train & evaluate SVD on ORIGINAL + injected MovieLens datasets
...
# ========= PATHS =========
ORIGINAL_PATH = Path(
    "/home/moshtasa/Research/phd-svd-recsys/Movie /data/df_final.csv"
)


INJ_ROOT = Path(
    "/home/moshtasa/Research/phd-svd-recsys/Movie /data/0115"
)

RESULTS_ROOT = Path(
    "/home/moshtasa/Research/phd-svd-recsys/SVD/Movie_Lens/result/rec/0115/SVD"
)
...
def main():
    start = time.time()
    now("=== SVD — MovieLens ORIGINAL + Injected ===")
    ...
    now(f"\n🏁 Finished all SVD runs (~{hrs:.2f} h)")
